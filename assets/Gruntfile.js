...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            development: {
                ...
                files: {
                    ...
                    'css/style-reversed.css': 'less/styles/style-reversed.less',
            ...
            production: {
                ...
                files: {
                    ...
                    'css/style-reversed.min.css': 'less/styles/style-reversed.less',
        ...
        cmq: {
            ...
            colors: {
                files: {
                    'css/style-blue-color.css': 'css/style-blue-color.css',
                    'css/style-pink-color.css': 'css/style-pink-color.css',
                    'css/style-green-color.css': 'css/style-green-color.css',
                    'css/style-berry-color.css': 'css/style-berry-color.css',
                    'css/style-orange-color.css': 'css/style-orange-color.css'
                }
            }
        },
    ...
    grunt.registerTask('production', ['clean', 'less:development', 'less:color', 'less:production', 'copy', 'cmq']);
